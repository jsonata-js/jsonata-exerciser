...
import ExternalLibsComponent, {
  getLibraryHandle
} from "./externalLibsComponent";
...
class Exerciser extends React.Component {
  constructor(props) {
    ...
    this.handleOpenExternalLibsModal = this.handleOpenExternalLibsModal.bind(
      this
    );
  ...
  setPanelState(panel, state) {
    this.setState({
      panelStates: { ...this.state.panelStates, [panel]: state }
    });
  }
      ...
      fetch(baseUri + "shared?id=" + this.props.data)
        ...
        .then(result => {
          return Promise.all([
            ...
            this.getExternalLibsInitialized(result.externalLibs)
          ]);
        })
        .then(
          ([result, externalLibs]) => {
      ...
      return fetch(lib.url)
        ...
        .then(libFileText => {
          ...
          return Promise.resolve({
            ...lib,
            libraryContext: { [lib.moduleName]: libraryContext }
          });
        });
    });
  ...
  loadJSONata(version, isBranch) {
    ...
    if (version === "local") {
      ...
      script.src =
        "https://rawgit.com/jsonata-js/jsonata/" + version + "/jsonata.js";
      label.innerHTML = "** " + version + " **";
    } else {
      version = version ? "@" + version : "";
      script.src =
        "https://cdn.jsdelivr.net/npm/jsonata" + version + "/jsonata.min.js";
      label.innerHTML = version;
      this.local = false;
    }
  ...
  eval() {
    ...
    try {
      ...
      bindings = new Function(...args, `return (${this.state.bindings})`)(
        ...args.map(a => externalLibs[a])
      );
    } catch (err) {
      console.log(err);
  ...
  clearMarkers() {
    ...
    this.jsonEditor.decorations = this.jsonEditor.deltaDecorations(
      this.jsonEditor.decorations,
      []
    );
  }
      ...
      pathresult = JSON.stringify(
        ...
        function(key, val) {
          return typeof val !== "undefined" && val !== null && val.toPrecision
            ...
            ? "{function:" +
              (val.signature ? val.signature.definition : "") +
              "}"
            : typeof val === "function"
  ...
  save(resp) {
    ...
    fetch(url, {
      ...
      .then(response => {
        ...
        const msg =
          'Share this link: <a href="' + location + '">' + location + "</a>";
  ...
  slack(resp) {
    ...
    fetch(url, {
      ...
      .catch(error => {
        console.error(error);
        document.getElementById("slack-title").innerHTML =
          "Error: " + error.message;
      });
  }
      ...
      <div className="App">
        <header className="App-header">
          <div id="banner">
            ...
            <div id="banner-strip" className="bannerpart">
              ...
              <div id="banner4">
                <a href="#share" onClick={this.handleOpenSaveModal.bind(this)}>
                  <img src={share} alt="Save and Share" />
                </a>
                <a href="http://docs.jsonata.org">
                  <img src={docs} alt="Documentation" />
                </a>
                <a href="http://twitter.com/intent/tweet?status=JSONata:  The JSON query and transformation language.+http://jsonata.org">
                  <img id="t-icon" src={twitter} alt={"Twitter"} />
                </a>
                <a href="#slack" onClick={this.handleOpenSlackModal.bind(this)}>
                  <img src={slack} alt={"Join us on Slack"} />
                </a>
                <a href="http://stackoverflow.com/search?q=JSONata">
                  <img src={stackoverflow} alt={"StackOverflow"} />
                </a>
                <a href="https://github.com/jsonata-js/jsonata">
        ...
        <SplitPane split="vertical" minSize={100} defaultSize={"50%"}>
          <SplitPane
            ...
            minSize={100}
            size={
              this.state.panelStates.bindings === "visible" ? "30%" : "20px"
            }
            primary="second"
            allowResize={this.state.panelStates.bindings === "visible"}
          >
            <div className="pane">
              <MonacoEditor
                language="json"
            ...
            <div className="w-full">
              <div
                ...
                onClick={() =>
                  this.setPanelState(
                    "bindings",
                    this.state.panelStates.bindings === "visible"
                      ? "hidden"
                      : "visible"
                  )
                }
              ...
              <div
                className="pane"
                hidden={this.state.panelStates.bindings !== "visible"}
              >
                <MonacoEditor
                  language="javascript"
                ...
                <button
                  id="add-libraries"
                  onClick={this.handleOpenExternalLibsModal.bind(this)}
                >
                  Add/Remove external libraries
                </button>
              </div>
            </div>
          </SplitPane>
          <SplitPane split="horizontal" minSize={50} defaultSize={170}>
            <div className="pane">
              ...
              />
              <div id="jsonata-label" className="label">
                JSONata
              </div>
              <select
                id="version-select"
        ...
        >
          <div>
            ...
            <p className="verify">
              Please check the box below to get a URL to your saved
              expression...
            </p>
        ...
        >
          <div>
            ...
            <p>
              <input id="slack-email" placeholder="Enter your email" />
            </p>
            <p className="verify">
              Please check the box below to get an invitation...
            </p>
            <form onSubmit={this.onSubmit}>
              <ReCAPTCHA
                ref={recaptchaRef}
        ...
        >
          <div>
            ...
            <ExternalLibsComponent
              onChange={this.onChangeExternalLibraries.bind(this)}
              externalLibs={this.state.externalLibs}
            />
          </div>
        </Modal>
